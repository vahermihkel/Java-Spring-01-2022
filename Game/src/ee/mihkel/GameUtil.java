...
public class GameUtil {
    ...
    protected static void checkIfPlayerAndEnemyMet(Player player, Enemy enemy, Scanner scanner) {
...
//                    throw new GameOverException();
    ...
    protected static void fightWithEnemy(Player player, Enemy enemy, Scanner scanner) {
